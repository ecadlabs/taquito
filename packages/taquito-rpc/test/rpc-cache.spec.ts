...
describe('RpcClientCache test', () => {
  ...
  beforeEach(() => {
    mockRpcClient = {
      ...
      getBalance: vi.fn(),
      getSpendable: vi.fn(),
      getBalanceAndFrozenBonds: vi.fn(),
      getSpendableAndFrozenBonds: vi.fn(),
      getFullBalance: vi.fn(),
      getStakedBalance: vi.fn(),
      getUnstakedFinalizableBalance: vi.fn(),
      getUnstakedFrozenBalance: vi.fn(),
      getUnstakeRequests: vi.fn(),
      getStorage: vi.fn(),
      getStorageUsedSpace: vi.fn(),
      getStoragePaidSpace: vi.fn(),
      getScript: vi.fn(),
      ...
      getDelegate: vi.fn(),
      getBigMapExpr: vi.fn(),
      getAllDelegates: vi.fn(),
      getDelegates: vi.fn(),
      getVotingInfo: vi.fn(),
      getConstants: vi.fn(),
      getBlockHeader: vi.fn(),
      getBlockMetadata: vi.fn(),
      getBakingRights: vi.fn(),
      getAttestationRights: vi.fn(),
      getBallotList: vi.fn(),
      getBallots: vi.fn(),
      getCurrentProposal: vi.fn(),
      getCurrentQuorum: vi.fn(),
      getVotesListings: vi.fn(),
      getProposals: vi.fn(),
      ...
      getSuccessorPeriod: vi.fn(),
      getProtocols: vi.fn(),
      getProtocolActivations: vi.fn(),
      getTicketBalance: vi.fn(),
      getAllTicketBalances: vi.fn(),
      getAdaptiveIssuanceLaunchCycle: vi.fn(),
      getPendingOperations: vi.fn(),
      getActiveStakingParameters: vi.fn(),
      getPendingStakingParameters: vi.fn(),
      getDestinationIndex: vi.fn(),
    };
    ...
    mockRpcClient.getDestinationIndex.mockReturnValue(destinationIndexResponse);
  ...
  it('getAllCachedData', async () => {
    ...
    await rpcCache.getDestinationIndex(address);
    ...
    expect(rpcCache.getAllCachedData()['rpcTest/getProtocolActivations//'].response).toEqual(
      protocolActivations
    );
    expect(
      rpcCache.getAllCachedData()[
    ...
    expect(
      rpcCache.getAllCachedData()[`rpcTest/getDestinationIndex/head/${address}/`].response
    ).toEqual(destinationIndexResponse);
  ...
  it('getAllCachedData when block level is different from head', async () => {
    ...
    await rpcCache.getDestinationIndex(address, block);
    ...
    expect(
      rpcCache.getAllCachedData()[`rpcTest/getActiveStakingParameters/${block.block}/${address}/`]
        .response
    ).toEqual(activeStakingParametersResponse);
    expect(
      rpcCache.getAllCachedData()[`rpcTest/getPendingStakingParameters/${block.block}/${address}/`]
        .response
    ).toEqual(pendingStakingParametersResponse);
    expect(
      rpcCache.getAllCachedData()[`rpcTest/getDestinationIndex/${block.block}/${address}/`].response
    ).toEqual(destinationIndexResponse);
    rpcCache.deleteAllCachedData();
  });
