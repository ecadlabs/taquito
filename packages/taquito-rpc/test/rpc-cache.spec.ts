...
describe('RpcClientCache test', () => {
    ...
    it('getAllCachedData', async done => {
        ...
        await rpcCache.packData({ "data": { "bytes": "0000b24ac1e1759565d5c9b69af8450ce7ea3d1ee64c" }, "type": { "prim": "bytes" } });
        ...
        expect(rpcCache.getAllCachedData()['rpcTest/getContract/head/address/'].response).toEqual(contract);
        expect(rpcCache.getAllCachedData()['rpcTest/getManagerKey/head/address/'].response).toEqual(managerKey);
        expect(rpcCache.getAllCachedData()['rpcTest/getDelegate/head/address/'].response).toEqual(delegate);
        expect(rpcCache.getAllCachedData()['rpcTest/getBigMapExpr/head/72/expruPtxxirR4BVqFH43VcmEFZqHaQHJhZQDRVTMgSYAGGgBhBRxfp/'].response).toEqual(bigmapValue);
        expect(rpcCache.getAllCachedData()['rpcTest/getDelegates/head/address/'].response).toEqual(delegates);
        expect(rpcCache.getAllCachedData()['rpcTest/getConstants/head/'].response).toEqual(constants);
        expect(rpcCache.getAllCachedData()['rpcTest/getBlockHeader/head/'].response).toEqual(blockHeader);
        expect(rpcCache.getAllCachedData()['rpcTest/getBakingRights/head/{}/'].response).toEqual(bakingRights);
        expect(rpcCache.getAllCachedData()['rpcTest/getEndorsingRights/head/{}/'].response).toEqual(endorsingRights);
        ...
        expect(rpcCache.getAllCachedData()['rpcTest/getCurrentPeriodKind/head/'].response).toEqual(currentPeriodKind);
        expect(rpcCache.getAllCachedData()['rpcTest/getCurrentProposal/head/'].response).toEqual(currentProposal);
        expect(rpcCache.getAllCachedData()['rpcTest/getCurrentQuorum/head/'].response).toEqual(currentQuorum);
        expect(rpcCache.getAllCachedData()['rpcTest/getVotesListings/head/'].response).toEqual(votesListing);
        expect(rpcCache.getAllCachedData()['rpcTest/getEntrypoints/head/address/'].response).toEqual(entryPoints);
        expect(rpcCache.getAllCachedData()['rpcTest/getChainId/'].response).toEqual(chainId);
        expect(rpcCache.getAllCachedData()['rpcTest/packData/head/{"data":{"bytes":"0000b24ac1e1759565d5c9b69af8450ce7ea3d1ee64c"},"type":{"prim":"bytes"}}/'].response).toEqual(packData);
        expect(rpcCache.getAllCachedData()['rpcTest/getCurrentPeriod/head/'].response).toEqual(currentPeriod);
        expect(rpcCache.getAllCachedData()['rpcTest/getSuccessorPeriod/head/'].response).toEqual(successorPeriod);
    ...
    it('getAllCachedData when block level is different from head', async done => {
        ...
        await rpcCache.getBigMapExpr('72', 'expruPtxxirR4BVqFH43VcmEFZqHaQHJhZQDRVTMgSYAGGgBhBRxfp', block);
        ...
        await rpcCache.getChainId();
        await rpcCache.packData({ "data": { "bytes": "0000b24ac1e1759565d5c9b69af8450ce7ea3d1ee64c" }, "type": { "prim": "bytes" } },block);
        ...
        expect(rpcCache.getAllCachedData()[`rpcTest/getScript/${block.block}/address/`].response).toEqual(script);
        expect(rpcCache.getAllCachedData()[`rpcTest/getContract/${block.block}/address/`].response).toEqual(contract);
        expect(rpcCache.getAllCachedData()[`rpcTest/getManagerKey/${block.block}/address/`].response).toEqual(managerKey);
        expect(rpcCache.getAllCachedData()[`rpcTest/getDelegate/${block.block}/address/`].response).toEqual(delegate);
        expect(rpcCache.getAllCachedData()[`rpcTest/getBigMapExpr/${block.block}/72/expruPtxxirR4BVqFH43VcmEFZqHaQHJhZQDRVTMgSYAGGgBhBRxfp/`].response).toEqual(bigmapValue);
        expect(rpcCache.getAllCachedData()[`rpcTest/getDelegates/${block.block}/address/`].response).toEqual(delegates);
        expect(rpcCache.getAllCachedData()[`rpcTest/getConstants/${block.block}/`].response).toEqual(constants);
        expect(rpcCache.getAllCachedData()[`rpcTest/getBlockHeader/${block.block}/`].response).toEqual(blockHeader);
        expect(rpcCache.getAllCachedData()[`rpcTest/getBakingRights/${block.block}/{"level":1111}/`].response).toEqual(bakingRights);
        expect(rpcCache.getAllCachedData()[`rpcTest/getEndorsingRights/${block.block}/{"level":1111}/`].response).toEqual(endorsingRights);
        expect(rpcCache.getAllCachedData()[`rpcTest/getBallotList/${block.block}/`].response).toEqual(ballotList);
        expect(rpcCache.getAllCachedData()[`rpcTest/getBallots/${block.block}/`].response).toEqual(ballots);
        expect(rpcCache.getAllCachedData()[`rpcTest/getCurrentPeriodKind/${block.block}/`].response).toEqual(currentPeriodKind);
        expect(rpcCache.getAllCachedData()[`rpcTest/getCurrentProposal/${block.block}/`].response).toEqual(currentProposal);
        expect(rpcCache.getAllCachedData()[`rpcTest/getCurrentQuorum/${block.block}/`].response).toEqual(currentQuorum);
        expect(rpcCache.getAllCachedData()[`rpcTest/getVotesListings/${block.block}/`].response).toEqual(votesListing);
        expect(rpcCache.getAllCachedData()[`rpcTest/getEntrypoints/${block.block}/address/`].response).toEqual(entryPoints);
        expect(rpcCache.getAllCachedData()[`rpcTest/getChainId/`].response).toEqual(chainId);
        expect(rpcCache.getAllCachedData()[`rpcTest/packData/${block.block}/{"data":{"bytes":"0000b24ac1e1759565d5c9b69af8450ce7ea3d1ee64c"},"type":{"prim":"bytes"}}/`].response).toEqual(packData);
        expect(rpcCache.getAllCachedData()[`rpcTest/getCurrentPeriod/${block.block}/`].response).toEqual(currentPeriod);
        expect(rpcCache.getAllCachedData()[`rpcTest/getSuccessorPeriod/${block.block}/`].response).toEqual(successorPeriod);
