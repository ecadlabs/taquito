...
describe('RPCEstimateProvider test wallet', () => {
  ...
  describe('smartRollupExecuteOutboxMessage', () => {
    it('should return estimate for smartRollupExecuteOutboxMessage operation', async (done) => {
      mockRpcClient.runOperation.mockResolvedValue(smartRollupExecuteOutboxMessageNoReveal);
      ...
      expect(estimate.gasLimit).toEqual(6485);
      expect(estimate.storageLimit).toEqual(16);
      expect(estimate.suggestedFeeMutez).toEqual(851);
      done();
    });
  });
