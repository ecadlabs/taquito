 ...
 */
export class ContractAbstraction<T extends ContractProvider<TContract> | Wallet<TContract>, TContract extends { methods: unknown, storage: unknown } = { methods: any; storage: any }> {
  /**
