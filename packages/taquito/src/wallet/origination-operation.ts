import { BlockResponse, OperationContentsAndResultOrigination, OperationContentsAndResultReveal, OpKind } from "@taquito/rpc";
...
export class OriginationWalletOperation extends WalletOperation {
  ...
  public async originationOperation() {
    ...
    return findWithKind(operationResult, OpKind.ORIGINATION) as OperationContentsAndResultOrigination | undefined;
  }

  public async revealOperation() {
    const operationResult = await this.operationResults();
    return findWithKind(operationResult, OpKind.REVEAL) as OperationContentsAndResultReveal | undefined;
  }
