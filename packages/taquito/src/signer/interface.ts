...
export interface Signer {
   ...
   * @param magicByte Magic bytes 11 for block, 12 for preendorsement/preattestation, 13 for endorsements/attestation, 3 for generic, 5 for the PACK format of michelson
   */
  sign(
    op: string,
