  ...
  },
  {
    ...
    args: [
      [
              ...
              { prim: 'GET' },
              {
                ...
                args: [
                  [
                    {
                      prim: 'PUSH',
                      args: [{ prim: 'string' }, { string: 'GET_FORCE' }],
                    },
                    { prim: 'FAILWITH' },
                  ],
                  [],
              ...
              { prim: 'GT' },
              {
                ...
                args: [
                  [
                    {
                      prim: 'PUSH',
                      args: [{ prim: 'string' }, { string: 'Balance is too low' }],
                    },
                    { prim: 'FAILWITH' },
                  ],
                  [
              ...
              { prim: 'LT' },
              {
                ...
                args: [
                  [
                    {
                      prim: 'PUSH',
                      args: [{ prim: 'string' }, { string: 'Balance cannot be negative' }],
                    },
                    { prim: 'FAILWITH' },
                  ],
                  [
        ...
        {
          prim: 'DIP',
          args: [[{ prim: 'DUP' }, { prim: 'CAR' }, { prim: 'CDR' }]],
        },
        { prim: 'PAIR' },
        {
          prim: 'DIP',
