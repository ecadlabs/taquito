...
describe('SaplingViewingKeyInMemory', () => {
  ...
  /* it('Should be instantiable with encrypted spending key', async (done) => {
        const viewer = await SaplingViewingKeyInMemory.fromSpendingKey('', 'test')
  ...
  /* it('Should be instantiable with a mnemonic', async (done) => {
        const viewer = await SaplingViewingKeyInMemory.fromMnemonic(['leopard', 'crouch', 'simple', 'blind', 'castle', 'they', 'elder', 'enact', 'slow', 'rate', 'mad', 'blanket', 'saddle', 'tail', 'silk', 'fury', 'quarter', 'obscure', 'interest', 'exact', 'veteran', 'volcano', 'fabric', 'cherry'], 'test')
        expect(viewer.getFullViewingKey().toString('hex')).toEqual('')
        done();
    }); */
