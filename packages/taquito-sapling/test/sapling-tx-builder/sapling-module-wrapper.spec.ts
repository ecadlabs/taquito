...
describe('SaplingWrapper', () => {
  ...
  it('signSpendDescription', async (done) => {
    const spendDescription = {
      ...
      nf: Buffer.from('a0678d948b2f39c8fe723dc0ab2302107de48ec746adb2fac636c3a5dec50de3', 'hex'),
      rk: Buffer.from('75a3311108abd110c767d19cca8e657cd6b58412868f48e05da04d0903ab95d3', 'hex'),
      rt: Buffer.from('25fa83c26fdb118353e9442c7cedd6919147d0029bc4bef236638396c2824557', 'hex'),
    };
    ...
    expect(signedSpendDesc.cv).toEqual(spendDescription.cv);
    expect(signedSpendDesc.proof).toEqual(spendDescription.proof);
    expect(signedSpendDesc.rk).toEqual(spendDescription.rk);
