...
describe('SaplingToolkit', () => {
  ...
  it('should return an instance of SaplingTransactionViewer based on sapling state id', async (done) => {
  ...
  it('Should prepare a valid shielded transaction based on sapling state id', async (done) => {
    mockReadProvider.getSaplingDiffById.mockResolvedValue({
  ...
  it('should throw when preparing a shielded transaction if the `to` parameter is not a shielded payment address', async (done) => {
    await expect(
  ...
  it('should throw when preparing a shielded transaction if the memo is too large', async (done) => {
    await expect(
      saplingToolkit.prepareShieldedTransaction([
        {
          to: 'zet12mVvzJ4QJhnNQetGHzdwTMcLgNrdC4SFact6BB5jpeqGAefWip3iGgEjvDA9z7b9Y',
  ...
  it('Should prepare a valid unshielded transaction to a tz1 address', async (done) => {
  ...
  it('Should prepare a valid unshielded transaction to a tz2 address', async (done) => {
    mockSaplingTxBuilder.createSaplingTx.mockResolvedValue({
      inputs: [
        {
          commitmentValue: Buffer.from(
  ...
  it('Should prepare a valid unshielded transaction to a tz3 address', async (done) => {
    mockSaplingTxBuilder.createSaplingTx.mockResolvedValue({
      inputs: [
        {
          commitmentValue: Buffer.from(
  ...
  it('should throw when preparing an unshielded transaction if the `to` parameter is not a Tezos address', async (done) => {
    await expect(
  ...
  it('should throw when preparing an unshielded transaction if the amount is higner than the available balance', async (done) => {
    await expect(
      saplingToolkit.prepareUnshieldedTransaction({
        to: 'tz2V17qQHTuQ3GJLu5bmPQDJTLDVwiWCrYFh',
        amount: 10,
  ...
  it('Should prepare a valid sapling transaction', async (done) => {
    mockSaplingTxBuilder.createSaplingTx.mockResolvedValue({
      inputs: [
        {
          commitmentValue: Buffer.from(
  ...
  it('should throw when preparing a sapling transaction if the `to` parameter is not a shielded payment address', async (done) => {
    await expect(
  ...
  it('should throw when preparing a sapling transaction if the memo is to large', async (done) => {
    await expect(
      saplingToolkit.prepareSaplingTransaction([
        {
          to: 'zet13KeFdzZ3tf8Aragg5iuMu3Ff8ZXXhzKhZF3mALYoL8spoPNvShf7THzo5tu4ynbJQ',
  ...
  it('should throw when preparing a sapling transaction if the amount is higner than the available balance', async (done) => {
    await expect(
      saplingToolkit.prepareSaplingTransaction([
        {
          to: 'zet13KeFdzZ3tf8Aragg5iuMu3Ff8ZXXhzKhZF3mALYoL8spoPNvShf7THzo5tu4ynbJQ',
