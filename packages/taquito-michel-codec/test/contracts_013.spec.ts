...
const contracts: {
  ...
  lib_protocol: [
    ...
    'temp_big_maps.tz',
    'timelock.tz',
    'tx_rollup_deposit_incorrect_entrypoint.tz',
    'tx_rollup_deposit_incorrect_param.tz',
    'tx_rollup_deposit_one_mutez.tz',
    'tx_rollup_deposit_pair_string.tz',
    'tx_rollup_deposit_string.tz',
    'tx_rollup_deposit.tz',
    'tx_rollup_parse_comparable_type.tz',
    'tx_rollup_parse_data.tz',
