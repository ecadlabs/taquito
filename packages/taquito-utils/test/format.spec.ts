...
describe('taquito.io example signing formatting', () => {
  it('Should be valid bytes taquito example https://taquito.io/docs/next/signing#generating-a-signature-with-beacon-sdk with proper padding for bytes length', () => {
