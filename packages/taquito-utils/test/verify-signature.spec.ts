...
describe('utils signature validation tests', () => {
  describe('SECP256K1 curve', () => {
    ...
    it('Should throw if the public key format is invalid', () => {
      ...
      expect(() => verifySignature(message, pk, sig)).toThrowError(/invalid checksum/);
    });
  ...
  describe('Invalid cases', () => {
    ...
    it('Should throw InvalidPublicKeyError if the public key is an empty string', () => {
      ...
      expect(() => verifySignature(message, pk, sig)).toThrowError(InvalidPublicKeyError);
      expect(() => verifySignature(message, pk, sig)).toThrowError(
        /public key provided cannot be empty/
      );
    });
    ...
    describe('Invalid cases', () => {
        ...
        it('Should throw InvalidMessageError if the message is an empty string', () => {
            ...
            expect(() => verifySignature(message, pk, sig)).toThrowError(InvalidMessageError);
            expect(() => verifySignature(message, pk, sig)).toThrowError(/message provided for verifying signature cannot be empty/);
        });
        ...
        it('Should throw InvalidSignatureError if the prefix of the signature is unknown', () => {
            const message = '';
            const pk = 'sppk7c7hkPj47yjYFEHX85q46sFJGw6RBrqoVSHwAJAT4e14KJwzoey';
            const sig = 'spesig1cdLkp1RLgUHAp13aRFkZ6MQDPp7xCnjAExGL3MBSdMDmT6JgQSX8cufyDgJRM3sinFtiCzLbsyP6d365EHoNevxhT47nx'
        ...
        it('Should throw InvalidSignatureError if the checksum of the signature is invalid', () => {
            const message = '';
            const pk = 'sppk7c7hkPj47yjYFEHX85q46sFJGw6RBrqoVSHwAJAT4e14KJwzoey';
            const sig = 'spsig1cdLkp1RLgUHAp13aRFkZ6MQDPp7xCnjAExGL3MBSdMDmT6JgQSX8cufyDgJRM3sinFtiCzLbsyP6d365EHoNevxhT47'
