...
export type SupportedNetworks = NetworkTypeBeacon.MAINNET | NetworkTypeBeacon.GHOSTNET  | NetworkTypeBeacon.QUEBECNET | NetworkTypeBeacon.RIONET | NetworkTypeWc.MAINNET | NetworkTypeWc.GHOSTNET | NetworkTypeWc.QUEBECNET | NetworkTypeWc.RIONET | NetworkTypeBeacon.CUSTOM;
