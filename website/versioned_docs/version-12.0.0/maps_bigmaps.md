...
```js live noInline
Tezos.contract
  .at('KT1ALm5dUKi47p8WRfX1AYzFG7A8YwE4LhRv')
  .then((myContract) => {
    return myContract
      .storage()
      .then((myStorage) => {
...
```js live noInline
Tezos.contract
  .at('KT1NoACbTF2wh2Zrz3aZLC5rr2nAqsBFa9gc')
  .then((myContract) => {
    return myContract.storage();
  })
  .then((myStorage) => {
...
```js live noInline
Tezos.contract
  .at('KT1HpDxVK67YxzAUs7Ubp7R7KzV3i1X1nZtD')
  .then((myContract) => {
    return myContract.storage();
  })
  .then((myStorage) => {
...
```js live noInline
Tezos.contract
  .at('KT1DXCqq3suQKEUoC4UtzNi1c6jNcunGynas')
  .then((myContract) => {
    return myContract
      .storage()
      .then((myStorage) => {
...
Tezos.contract
  .at('KT1MMfuLrpBufDyxrLFkxBNE73Lp3AWkHivG')
  .then((contract) => {
