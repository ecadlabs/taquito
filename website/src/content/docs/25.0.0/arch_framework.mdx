...
- R2: [Michelson](https://octez.tezos.com/docs/active/michelson.html)
- R3: [Micheline](https://octez.tezos.com/docs/shell/micheline.html)
- R4: [Tezos Developer Documentation](https://docs.tezos.com)
- R5: [Sapling](https://octez.tezos.com/docs/active/sapling.html)
- R6: Tezos Baker Fee
- R7: [Tezos Software Architecture](https://octez.tezos.com/docs/introduction/tezos.html)
- R8: [Tezos JSON/RPC Interface](https://octez.tezos.com/docs/alpha/rpc.html)
- R9: [Tezos RPC Nodes](rpc_nodes)
- R10: [Tezos RPCs, Reference](https://octez.tezos.com/docs/alpha/rpc.html)
...
Tezos supports smart contracts through a domain-specific language known as [Michelson](https://octez.tezos.com/docs/active/michelson.html) (see R2). Michelson is a low-level, stack-based, strongly typed functional programming language. As a declarative language, Michelson programs can be formally verified, i.e., mathematically proven correct. This is particularly important in this context and relates to the earlier point regarding the importance of validating automated smart contract logic before deployment. Michelson's strong typing also enhances security, another real concern in an authoritative, decentralized, shared ledger. [Micheline](https://octez.tezos.com/docs/shell/micheline.html) (see R3) is the concrete syntax for the Michelson language.
...
[Sapling](https://octez.tezos.com/docs/active/sapling.html) (see R5) is a protocol that addresses the need of exchanging fungible tokens on a decentralized Ledger. For Taquito's Sapling support, see the [Sapling toolkit documentation](sapling). For a privacy-preserving transaction (aka shielded transaction) the sender and receiver are only visible to the parties involved.
...
As described in [R10](https://octez.tezos.com/docs/alpha/rpc.html), the RPC Interface includes endpoints to Query the Ledger as well as several processing endpoints covering such things as operation injections and data serializations. The endpoints of interest to Taquito are covered here.

[JSON Micheline](https://octez.tezos.com/docs/shell/micheline.html) is a JSON encoding of Micheline (see R3). It is used by RPC endpoints to represent Micheline.
