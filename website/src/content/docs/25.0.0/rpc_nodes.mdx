...
**ECAD Infra public RPC shutdown:** ECAD Infra's public RPC endpoints at `*.tezos.ecadinfra.com` were shut down on May 31, 2026 and no longer serve traffic. If your wallet, dApp, indexer, or tooling still points at these endpoints, migrate to one of the community nodes listed below. See the [shutdown announcement](https://forum.tezosagora.org/t/public-rpc-service-shutdown-may-31-2026/7064) and the [new public RPC nodes announcement](https://forum.tezosagora.org/t/annoucing-new-public-rpc-nodes-for-tezos-community/7082).
