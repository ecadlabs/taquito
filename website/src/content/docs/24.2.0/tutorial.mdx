...
<details>
  ...
  ```bash
    ...
    octez-client -E https://tezos-shadownet.octez.io gen keys mysamplekey -s secp256k1
    octez-client -E https://tezos-shadownet.octez.io show address mysamplekey -S
  ```
...
const App = () => {
  const [Tezos] = useState<TezosToolkit>(
    new TezosToolkit("https://tezos-shadownet.octez.io")
  );
