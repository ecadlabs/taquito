...
## Cycle
A cycle is 14400 blocks and every 6 seconds per block in Tallinn protocol. This means a cycle is about 1 day. This might change with the activation of newer protocols.
