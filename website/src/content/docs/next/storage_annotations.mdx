---
title: Storage With and Without Annotations
...
Note that when proprieties have annotations, we cannot access them by index. For example, if you replace `theNat` with 2 and `theNumber` with 3 in this example, it will fail.
