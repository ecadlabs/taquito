...
The Ligo source code for the smart contract [KT1BJadpDyLCACMH7Tt9xtpx4dQZVKw9cDF7](https://ghostnet.tzkt.io/KT1BJadpDyLCACMH7Tt9xtpx4dQZVKw9cDF7/operations/) used in this example can be found [here](https://ide.ligolang.org/p/2sVshnZ_Aat5pIuUypIBsQ).
