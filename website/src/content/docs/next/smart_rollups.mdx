...
Taquito supports Smart Rollup operations. In this document, we will go through the operations we support. For a deeper understanding of how rollups work, refer to the [Octez Smart Rollups documentation](https://octez.tezos.com/docs/active/smart_rollups.html).
