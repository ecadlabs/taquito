...
>
> Even in a development environment, you should use environment variables that are never commited to your version control system.
...
8. The user makes an interaction that requires sending an operation to the blockchain (such as a tranfer of tokens)
