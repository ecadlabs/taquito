...
## Introduction
Contract events are a way for contracts to deliver event-like information to third-party (off-chain) applications. They can be emitted by using the `EMIT` instruction in Michelson.
...
```json
{
  "opHash": "ons9uZA4szpyvbUgMj69AraFv5LoEfBxmvWK8rtxTpuRJvgbV3W",
  "blockHash": "BMHBteR1T89rrisFeNC1q3VMfNSaWjWT8vHaY5aUc6n6MB21zZP",
  "level": 507394,
  "kind": "event",
  "source": "KT1WWC2JxEPohgBktSqe6NJ4iuuqMMm1zHCj",
  "nonce": 1,
  "type": {
    "prim": "int"
  },
