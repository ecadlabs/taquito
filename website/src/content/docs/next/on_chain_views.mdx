...
- On-chain views are a core Tezos feature, available on all current networks.
...
```js live
const contractTopLevelViews = '__FIXTURE_onChainViewTopLevelContract__';
const contractCallFib = '__FIXTURE_onChainViewCallerContract__';
