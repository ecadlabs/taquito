...
This tutorial uses a [smart contract deployed on shadownet](https://shadownet.tzkt.io/KT1WdjpRSsmC93iPkXqkm2XZcbv6CSwKeqpj/operations/) with a map containing addresses as keys and tez as values.
