...
To become a baker, all you need to do is to run your own node with baking software and keep it online and up to date. You will also need a minimum of <TezosConstant name="minimalStake" version="23.0.0" /> tez to participate in baking.
