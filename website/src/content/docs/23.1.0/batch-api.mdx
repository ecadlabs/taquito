...
// (i.e, batch.withTransfer, batch.withOrigination, etc)
...
- [Integration tests](https://github.com/ecadlabs/taquito/blob/master/integration-tests/__tests__/wallet/batch.spec.ts)
- [Documentation](https://taquito.io/typedoc/classes/_taquito_taquito.walletoperationbatch.htmlhttps://taquito.io/typedoc/classes/_taquito_taquito.WalletOperationBatch)
