...
| Provider         | URL                                   | Block | Protocol | Timestamp                                                                           | Received                                                                      |
| ---------------- | ------------------------------------- | ----- | -------- | ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| ECAD Infra       | https://shadownet.tezos.ecadinfra.com  | <BlockLevel network="ghostnet" rpcUrl="https://shadownet.tezos.ecadinfra.com" /> | <BlockProtocol network="ghostnet" rpcUrl="https://shadownet.tezos.ecadinfra.com" /> | <BlockTimestamp network="ghostnet" rpcUrl="https://shadownet.tezos.ecadinfra.com" /> | <BlockReceivedAgo network="ghostnet" rpcUrl="https://shadownet.tezos.ecadinfra.com" /> |
