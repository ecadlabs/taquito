...
async function example() {
  try {
    ...
    await tezos.contract.at('KT1CYH2LNFwYPLGXenEwtXaPeAy5ActRB3SX').then(async contract => { // knownBigMapContract used in integration tests
    ...
    await tezos.contract.at('KT1CYH2LNFwYPLGXenEwtXaPeAy5ActRB3SX').then(async contract => {
