...
async function originateKnownContract() {
  tezos.setSignerProvider(signer);
  try {
    ...
    const contract = await opknownContract.contract();
    console.log(
...
async function originateknownBigMapContract() {
  tezos.setSignerProvider(signer);
  try {
    ...
    console.log('Awaiting confirmation...');
    const contract = await opknownBigMapContract.contract();
    console.log(
...
async function originateSaplingStateContract() {
  tezos.setSignerProvider(signer);
  try {
