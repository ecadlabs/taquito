...
CONFIGS().forEach(({ lib, rpc, setup }) => {
  ...
  describe(`Lambda view using: ${rpc}`, () => {
    ...
    test('Originate FA1.2 contract and fetch data from view entrypoints', async (done) => {
    ...
    test('Originate a contract and fetch data from view entrypoints', async (done) => {
    ...
    test('Originate FA2 contract and fetch data from view entrypoints', async (done) => {
