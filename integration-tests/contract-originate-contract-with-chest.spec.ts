...
=======
    ...
    test('Verify contract.originate for a contract with chest in storage', async (done) => {
>>>>>>> Stashed changes
...
=======
    test('Verify contract.originate for a contract with chest_key in storage', async (done) => {
>>>>>>> Stashed changes
