...
<<<<<<< HEAD
    hangzhounetOrHigher('Verify contract.originate for a contract with chest in storage', async (done) => {
=======
    test('originates a contract with chest in storage', async (done) => {
>>>>>>> master
...
<<<<<<< HEAD
    hangzhounetOrHigher('Verify contract.originate for a contract with chest_key in storage', async (done) => {
=======
    test('originates a contract with chest_key in storage', async (done) => {
>>>>>>> master
