...
CONFIGS().forEach(({ lib, rpc, setup, knownBaker, createAddress, knownTicketContract }) => {
  ...
  const createFundedTz2 = async () => {
    const tz2 = await createAddress(PrefixV2.Secp256k1SecretKey);
  ...
  const createFundedRevealedTz2 = async () => {
    const tz2 = await createFundedTz2();
  ...
  describe(`Test tz2 account operations through contract API using: ${rpc}`, () => {
    ...
    beforeAll(async () => {
      ...
      Tz2 = await createFundedTz2();
    });

    step('verify that reveal fee and gas is sufficient', async () => {
    ...
    step('verify that transfer to revealed account fee and gas is sufficient', async () => {
    ...
    step('verify that transfer to unrevealed account fee and gas is sufficient', async () => {
    ...
    step('verify that originate fee and gas is sufficient', async () => {
    ...
    step('verify that contractCall fee and gas is sufficient', async () => {
    ...
    step('verify that setDelegate fee and gas is sufficient', async () => {
    ...
    step('verify that registerDelegate fee and gas is sufficient', async () => {
    ...
    step('verify that increase_paid_storage fee and gas is sufficient', async () => {
    ...
    step('verify that register_global_constant fee and gas is sufficient', async () => {
  ...
  describe(`Test tz2 consensus key updates through contract API using: ${rpc}`, () => {
    let Tz2: TezosToolkit;
  ...
  describe(`Test tz2 companion key updates through contract API using: ${rpc}`, () => {
    let Tz2: TezosToolkit;
  ...
  describe(`Test tz2 ticket and smart rollup operations through contract API using: ${rpc}`, () => {
    let Tz2: TezosToolkit;
    ...
    beforeAll(async () => {
      ...
      Tz2 = await createFundedRevealedTz2();
    });
    ...
    it('verify that smart_rollup_originate fee and gas is sufficient', async () => {
      const kernel = '';
