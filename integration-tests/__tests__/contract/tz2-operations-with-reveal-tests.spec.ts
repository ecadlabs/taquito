...
CONFIGS().forEach(({ lib, rpc, setup, knownBaker, createAddress, knownTicketContract }) => {
  ...
  describe(`Test tz2 account operations through contract API using: ${rpc}`, () => {
    ...
    step('verify that update_consensus_key fee and gas is sufficient', async () => {
    ...
    step('verify that update_companion_key fee and gas is sufficient', async () => {
    ...
    step('verify that transferTicket fee and gas is sufficient', async () => {
    ...
    step('verify that smart_rollup_originate fee and gas is sufficient', async () => {
    ...
    step('verify that smart_rollup_add_messages fee and gas is sufficient', async () => {
