...
const mumbainetEphemeral = {
  ...
  rpcCacheMilliseconds: process.env['RPC_CACHE_MILLISECONDS'] || '1000',
  knownBaker: process.env['TEZOS_BAKER'] || 'tz1cjyja1TU6fiyiFav3mFAdnDsCReJ12hPD',
  knownContract: process.env['TEZOS_MUMBAINET2_CONTRACT_ADDRESS'] || knownContractPtMumbai2,
  knownBigMapContract: process.env['TEZOS_MUMBAINET2_BIGMAPCONTRACT_ADDRESS'] || knownBigMapContractPtMumbai2,
  knownTzip1216Contract: process.env['TEZOS_MUMBAINET2_TZIP1216CONTRACT_ADDRESS'] || knownTzip12BigMapOffChainContractPtMumbai2,
  knownSaplingContract: process.env['TEZOS_MUMBAINET2_SAPLINGCONTRACT_ADDRESS'] || knownSaplingContractPtMumbai2,
  knownViewContract: process.env['TEZOS_MUMBAINET2_ON_CHAIN_VIEW_CONTRACT'] || knownOnChainViewContractAddressPtMumbai2,
