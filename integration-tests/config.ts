...
const defaultConfig = ({
  ...
  return {
    ...
    knownBaker: process.env[`TEZOS_BAKER`] || (networkName === 'WEEKLYNET' ? 'tz1ck3EJwzFpbLVmXVuEn5Ptwzc6Aj14mHSH' : networkName === 'OXFORDNET' ? 'tz1cjyja1TU6fiyiFav3mFAdnDsCReJ12hPD' : 'tz1TnEtqDV9mZyts2pfMy6Jw1BTPs4LMjL8M'),
...
const parisbnetSecretKey: Config =
  defaultConfig({
    networkName: 'PARISBNET',
    protocol: Protocols.PtParisBQ,
    defaultRpc: 'https://rpc.parisbnet.teztnets.com',
...
} else if (process.env['RUN_PARISBNET_WITH_SECRET_KEY']) {
  providers.push(parisbnetSecretKey);
