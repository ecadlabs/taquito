  ...
  describe('Verify LedgerSigner', () => {
    ...
    describe('Verify bip32 signature', () => {
      ...
      it('Verify that the signature is correct', async (done) => {
        ...
        const contract = await Tezos.contract.originate(contractOriginationParams)
    ...
    describe('Verify bip32 signature', () => {
      ...
      it('Verify that the signature is correct', async (done) => {
        ...
        const b = await localForger.forge(rpcToForge)
          const sig = await signer.sign(b, new Uint8Array([3]))
