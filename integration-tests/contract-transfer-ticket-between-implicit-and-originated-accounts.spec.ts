...
CONFIGS().forEach(({ lib, rpc, setup, createAddress }) => {
  ...
  _describe(`Test transfer ticket between implicit and originated accounts, in ${rpc}`, () => {
    ...
    _it('will send 3 tickets from an originated to an implicit account', async () => {
    ...
    _it('will transfer 1 tickets from an implicit to another implicit account', async () => {
    ...
    _it('will transfer 1 ticket from an implicit to an originated account', async () => {
    ...
    _it('will send 1 ticket from an origianted to another originated account to dispose', async () => {
