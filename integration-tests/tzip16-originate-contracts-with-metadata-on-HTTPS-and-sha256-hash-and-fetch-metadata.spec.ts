...
CONFIGS().forEach(({ lib, rpc, setup }) => {
 ...
 console.log("countRpc:Fetch metadata of the contract having a sha256 hash in URI ")
 console.log(countRpc.entries())
 expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/constants`)).toEqual(3); //5
 expect(countRpc.get(`${rpc}/chains/main/blocks/head/metadata`)).toEqual(4);
// expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/${signer}/manager_key`)).toEqual(2);
 ...
 expect(countRpc.get(`${rpc}/chains/main/blocks/head/helpers/scripts/pack_data`)).toEqual(1);
  ...
  const countRpc = (Tezos.rpc['httpBackend'] as HttpBackendForRPCCache).rpcCountingMap;
console.log("signer: "+signer)
 console.log("countRpc:Deploy a contract having an invalid sha256 hash in URI "+countRpc)
  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/${signer}/balance`)).toEqual(1);
  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/constants`)).toEqual(5);//7
  ...
  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/${contractAddress}/entrypoints`)).toEqual(2);
  expect(countRpc.get(`${rpc}/chains/main/blocks/head/helpers/scripts/pack_data`)).toEqual(1);
  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/big_maps/133553/expru5X1yxJG6ezR2uHMotwMLNmSzQyh5t1vUnhjx4cS6Pv9qE1Sdo`)).toEqual(1);
  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/${contractAddressInvalidHash}/balance`)).toEqual(1);
  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/${contractAddressInvalidHash}/manager_key`)).toEqual(2);
  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/${contractAddressInvalidHash}`)).toEqual(2);
  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/KT1VaqHiZnTgpFvfmcetjLJRY1PWoG1iPmmd/script`)).toEqual(2);
  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/KT1VaqHiZnTgpFvfmcetjLJRY1PWoG1iPmmd/entrypoints`)).toEqual(2);
  //expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/big_maps/133554/expru5X1yxJG6ezR2uHMotwMLNmSzQyh5t1vUnhjx4cS6Pv9qE1Sdo`)).toEqual(1);
...
//  const countRpc = (Tezos.rpc['httpBackend'] as HttpBackendForRPCCache).rpcCountingMap;
//  console.log("signer: "+signer)
// console.log("countRpc:Fetch metadata of the contract having a sha256 hash in URI "+countRpc)
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/tz2A5U7AVtYyxSfCefjsMMKyPTqVwZAryr3X/balance`)).toEqual(1);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/constants`)).toEqual(5);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/metadata`)).toEqual(8);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/tz2A5U7AVtYyxSfCefjsMMKyPTqVwZAryr3X/manager_key`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/header`)).toEqual(8);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/tz2A5U7AVtYyxSfCefjsMMKyPTqVwZAryr3X`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/helpers/forge/operations`)).toEqual(4);
//  expect(countRpc.get(`${rpc}/chains/main/chain_id`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/helpers/scripts/run_operation`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/helpers/preapply/operations`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/injection/operation`)).toEqual(2);
//  //expect(countRpc.get(`${rpc}/chains/main/blocks/head`)).toEqual(8);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/KT1K5owg7jSKZW1ZgEr3XDKnbnkXfTDqzFfz/script`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/KT1K5owg7jSKZW1ZgEr3XDKnbnkXfTDqzFfz/entrypoints`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/helpers/scripts/pack_data`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/big_maps/133553/expru5X1yxJG6ezR2uHMotwMLNmSzQyh5t1vUnhjx4cS6Pv9qE1Sdo`)).toEqual(1);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/tz2VQhxFkaPqetC8FjwsTm1wFa1izoLotZ1o/balance`)).toEqual(1);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/tz2VQhxFkaPqetC8FjwsTm1wFa1izoLotZ1o/manager_key`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/tz2VQhxFkaPqetC8FjwsTm1wFa1izoLotZ1o`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/KT1VaqHiZnTgpFvfmcetjLJRY1PWoG1iPmmd/script`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/contracts/KT1VaqHiZnTgpFvfmcetjLJRY1PWoG1iPmmd/entrypoints`)).toEqual(2);
//  expect(countRpc.get(`${rpc}/chains/main/blocks/head/context/big_maps/133554/expru5X1yxJG6ezR2uHMotwMLNmSzQyh5t1vUnhjx4cS6Pv9qE1Sdo`)).toEqual(1);
//         done();
